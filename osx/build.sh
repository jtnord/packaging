...
pkgbuild --root packages/war/app \
         --identifier @@OSX_IDPREFIX@@.@@ARTIFACTNAME@@.war \
         --version @@VERSION@@ \
...
pkgbuild --root packages/launchd_daemon/app \
         --identifier @@OSX_IDPREFIX@@.@@ARTIFACTNAME@@.launchd_daemon \
         --version @@VERSION@@ \
...
pkgbuild --root packages/launchd_user/app \
         --identifier @@OSX_IDPREFIX@@.@@ARTIFACTNAME@@.launchd_@@ARTIFACTNAME@@ \
         --version @@VERSION@@ \
         --install-location /Library/LaunchDaemons/ \
...
pkgbuild --root packages/support/app \
         --identifier @@OSX_IDPREFIX@@.@@ARTIFACTNAME@@.support \
         --version @@VERSION@@ \
...
pkgbuild --root packages/documentation/app \
         --identifier @@OSX_IDPREFIX@@.@@ARTIFACTNAME@@.documentation \
         --version @@VERSION@@ \
